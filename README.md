...
| GP14              | SWDIO        | Дата SWD   |
| GP15              | SWCLK        | Такт SWD   |
| GP27              | NRST         | Сброс цели |
| GP26              | VDD (3.3 В)\*| Питание цели / ключ питания |
| GND               | GND          | Общая земля |

\* GP26 — вывод, который Pico может подтягивать к 3.3 В для подачи питания. Если ток цели выше возможностей Pico, ставьте реле/мосфет, управляемый этим пином. Если питание отключать не нужно (есть отдельный источник), оставьте GP26 неподключённым и вручную выполняйте power‑cycle.
...
4. Подключите Pico к цели, подайте питание (или дайте Pico управлять питанием).
