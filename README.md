...
| GP16              | WS2812 DIN   | Адресный статус‑светодиод на плате RP2040‑Tiny |
| GND               | GND          | Общая земля |
...
- Зелёный — размер флеш успешно автоопределён / завершено без ошибок.
- Красный — ошибка автоопределения или чтения.
- Синий — идёт дамп.
